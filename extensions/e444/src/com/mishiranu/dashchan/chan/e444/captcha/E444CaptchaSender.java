...
public final class E444CaptchaSender {
	public static final class CaptchaPostData {
		...
		private CaptchaPostData(String captchaType, String captchaId, String captchaValue, String recaptchaResponse,
				String session) {
	...
	public static CaptchaPostData buildCaptchaPostData(ChanPerformer.SendPostData data, String session) {
		...
		if (data.captchaData != null) {
			String dataCaptchaType = StringUtils.nullIfEmpty(data.captchaData.get(E444CaptchaReader.CAPTCHA_DATA_KEY_TYPE));
