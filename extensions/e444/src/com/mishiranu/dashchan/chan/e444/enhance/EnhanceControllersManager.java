...
import com.mishiranu.dashchan.chan.e444.enhance.controllers.EnhanceControllerPostButton;
...
final class EnhanceControllersManager {
	private static final List<EnhanceController> CONTROLLERS = Collections.unmodifiableList(Arrays.asList(
			EnhanceControllerBadge.getInstance(),
			EnhanceControllerPostButton.getInstance()));
	...
	private static final class ActivityStateObserver {
		...
		ActivityStateObserver(ViewTreeObserver.OnGlobalLayoutListener layoutListener,
	...
	private static void attachActivityStateObserver(Activity activity) {
		...
		ViewTreeObserver.OnGlobalLayoutListener layoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				if (observedActivity == null || observedActivity.isFinishing()
