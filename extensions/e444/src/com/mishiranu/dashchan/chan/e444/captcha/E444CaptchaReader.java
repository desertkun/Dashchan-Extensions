...
public final class E444CaptchaReader {
    ...
    private static boolean checkSlideCaptcha(
        ...
        HttpResponse response = E444IpRequestPerformer.request(data, "api", "captcha", "slide", "check")
                .param("v", value)
                .configure(
    ...
    public static ChanPerformer.ReadCaptchaResult onReadCaptcha(
        ...
        if (isRecaptchaType(captchaType)) {
            ...
            HttpResponse response = E444IpRequestPerformer.request(data, "api", "captcha", "slide", "id")
                    .param("v", value)
                    .configure(request -> request.addCookie(E444CaptchaSession.COOKIE_SESSION, requestSession))
                    .perform();
            ...
            Integer selectedX;
            try {
                selectedX = E444SlideCaptchaUtils.chooseSlideCaptchaX(
            ...
            ChanPerformer.CaptchaData captchaData = new ChanPerformer.CaptchaData();
            captchaData.put(
                    ChanPerformer.CaptchaData.CHALLENGE,
