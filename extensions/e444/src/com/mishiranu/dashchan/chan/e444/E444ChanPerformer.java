...
public class E444ChanPerformer extends ChanPerformer {
				...
				if (!boardConfiguration.handle(reader, name)) {
					switch (name) {
						case "threads": {
							reader.startArray();
							while (!reader.endStruct()) {
								threads.add(E444ModelMapper.createThread(reader, locator));
							}
							break;
						}
						case "board_speed": {
	...
	public ReadPostsResult onReadPosts(ReadPostsData data) throws HttpException, InvalidResponseException {
		...
		try (InputStream input = response.open();
			...
			E444ModelMapper.BoardConfiguration boardConfiguration =
					new E444ModelMapper.BoardConfiguration();
						...
						case "threads": {
							...
							while (!reader.endStruct()) {
								switch (reader.nextName()) {
									case "posts": {
										posts = E444ModelMapper.createPosts(reader, locator, null);
										break;
									}
									default: {
										reader.skip();
	...
	public ReadCaptchaResult onReadCaptcha(ReadCaptchaData data) throws HttpException, InvalidResponseException {
		...
		return E444CaptchaReader.onReadCaptcha(this, data,
